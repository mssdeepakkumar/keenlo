...
class WC_Bookings_Menus {
	...
	public function admin_menu() {
		...
		$pass 				 = add_submenu_page( 'edit.php?post_type=wc_booking', __( 'Pass Section', 'woocommerce-bookings' ), __( 'Pass Section', 'woocommerce-bookings' ), 'manage_bookings', 'pass_section', array( $this, 'pass_section' ) );
	...
	public function pass_section() {
		...
		include( 'views/html-pass-section.php' );
	}
