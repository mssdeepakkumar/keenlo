    ...
    if (!class_exists('DOPBSPWooCommerceVariation')){
        class DOPBSPWooCommerceVariation extends DOPBSPWooCommerce{
            ...
            function add(){
                ...
                add_post_meta($variation_id, '_price', $cart[0]['price_total']);
                ...
                add_post_meta($variation_id, '_virtual', 'no');
		...
		update_post_meta($product_id, '_product_attributes', $attributes);
            ...
            function clean(){
                ...
                $variations = $wpdb->get_results('SELECT * FROM '.$DOPBSP->tables->woocommerce.' WHERE date_created < DATE_SUB(CURDATE(),INTERVAL 14 DAY)');
