...
* Version                 : 2.0
* File                    : assets/js/jquery.dop.frontend.BSPReservationsAdd.js
* File Version            : 1.0
             ...
             */
                ...
                if (!DOPPrototypes.isTouchDevice()){
                    ...
                    $(document).mousemove(function(e){
                         ...
                         * Tooltip height.
                         */
                        h = $('#DOPBSPReservationsAdd-tooltip'+ID).height()
                            +parseFloat($('#DOPBSPReservationsAdd-tooltip'+ID).css('padding-top'))
                            +parseFloat($('#DOPBSPReservationsAdd-tooltip'+ID).css('padding-bottom'))
                            +parseFloat($('#DOPBSPReservationsAdd-tooltip'+ID).css('border-top-width'))
                            +parseFloat($('#DOPBSPReservationsAdd-tooltip'+ID).css('border-bottom-width'));
                     ...
                     */
                    $('#DOPBSPReservationsAdd-tooltip'+ID).unbind('touchstart');
                    $('#DOPBSPReservationsAdd-tooltip'+ID).bind('touchstart', function(e){
                        e.preventDefault();
...
// 6. Calendar
        ...
        methods_calendar = {
             ...
             */
                ...
                $('#DOPBSP-column3 .column-content').html(methods_sidebar.display());
            },
            init:function(year,
                          month){
            /*
                 ...
                 */  
                    ...
                    if (Container.width() < 500
                        ...
                        if (methods_sidebar.data['style'] === '5'){                  
                            $('.DOPBSPReservationsAdd-sidebar', Container).removeAttr('style');            
                        }
                    }
                    else{
                        if (methods_sidebar.data['style'] === '5'){
                            $('.DOPBSPReservationsAdd-container', Container).width((Container.width()-20)/2);                            
                            $('.DOPBSPReservationsAdd-sidebar', Container).width((Container.width()-20)/2);                            
                        }
                        else{
                            $('.DOPBSPReservationsAdd-container', Container).width(Container.width()-$('.DOPBSPReservationsAdd-sidebar', Container).width()-parseFloat($('.DOPBSPReservationsAdd-sidebar', Container).css('margin-left')));
                        }
                    }
        ...
        methods_day = {
             ...
             */
                ...
                if (price > 0 
                        && (bind === 0 
                                || bind === 1)){
                    contentLine1 = methods_currency.data['position'] === 'before' ? methods_currency.data['sign']+DOPPrototypes.getWithDecimals(price):
                                                                                    DOPPrototypes.getWithDecimals(price)+methods_currency.data['sign'];
                }

                if (promo > 0 
                        && (bind === 0 
                                || bind === 1)){
                    contentLine1 = methods_currency.data['position'] === 'before' ? methods_currency.data['sign']+DOPPrototypes.getWithDecimals(promo):
                                                                                    DOPPrototypes.getWithDecimals(promo)+methods_currency.data['sign'];
                }
                ...
                if (promo > 0 
                        && (bind === 0 
                                || bind === 1)){
                    dayHTML.push('          <div class="dopbsp-old-price">'+(methods_currency.data['position'] === 'before' ? methods_currency.data['sign']+DOPPrototypes.getWithDecimals(price):DOPPrototypes.getWithDecimals(price)+methods_currency.data['sign'])+'</div>');
                }
        ...
        methods_hours = {
             ...
             */
                ...
                if (methods_search.days.validate(day) 
                    ...
                    noHours = DOPPrototypes.getHoursDifference(startHour, endHour, 'hours')+((!methods_hours.data['addLastHourToTotalPrice'] || methods_hours.data['interval']) && methods_hours.data['multipleSelect'] ? 0:1);
                    
                    if (noHours < minNoHours){
                        DOPBSP.toggleMessages('error',
                                              methods_rules.text['minTimeLapseHoursWarning'].replace(/%d/gi, minNoHours));
                    ...
                    if (maxNoHours !== 0
                            && noHours > maxNoHours){
                        DOPBSP.toggleMessages('error',
                                              methods_rules.text['maxTimeLapseHoursWarning'].replace(/%d/gi, maxNoHours));
                        methods_reservation.toggleMessages(methods_reservation.text['selectHours'], '');
                        return false;
                    }
             ...
             */
                ...
                if (status !== 'past-hour'){
                    if (price > 0 
                            && (bind === 0 
                                    || bind === 1)){
                        priceContent = methods_currency.data['position'] === 'before' ? methods_currency.data['sign']+DOPPrototypes.getWithDecimals(price):DOPPrototypes.getWithDecimals(price)+methods_currency.data['sign'];
                    }

                    if (promo > 0 
                            && (bind === 0 
                                    || bind === 1)){
                        priceContent = methods_currency.data['position'] === 'before' ? methods_currency.data['sign']+DOPPrototypes.getWithDecimals(promo):DOPPrototypes.getWithDecimals(promo)+methods_currency.data['sign'];
                    }
                ...
                if (promo > 0 
                        ...
                        && (bind === 0 
                                || bind === 1)){                                      
                    hourHTML.push('        <div class="dopbsp-old-price">'+(methods_currency.data['position'] === 'before' ? methods_currency.data['sign']+DOPPrototypes.getWithDecimals(price):DOPPrototypes.getWithDecimals(price)+methods_currency.data['sign'])+'</div>');
                }                        
...
// 10. Sidebar
        ...
        methods_sidebar = {
             ...
             */
                ...
                $('.DOPBSPReservationsAdd-sidebar', Container).removeClass('dopbsp-style1')
                ...
                if (Container.width() < 500){
                    $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style-small');
                }
                else{
                    switch (methods_sidebar.data['style']){
                        case '2':
                            if (Container.width() < 760){
                                $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style2-medium');
                            }
                            else{
                                $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style2');
                            }
                            break;
                        case '3':
                            if (Container.width() < 1020){
                                $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style3-medium');
                            }
                            else{
                                $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style3');
                            }
                            break;
                        case '4':
                            if (Container.width() < 660){
                                $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style4-medium');
                            }
                            else{
                                $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style4');
                            }
                            break;
                        case '5':
                            if (Container.width() < 800){
                                $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style5-medium');
                            }
                            else{
                                $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style5');
                            }
                            break;
                        default:                 
                            if (Container.width() < 900){
                                $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style1-medium');
                            }
                            else{
                                $('.DOPBSPReservationsAdd-sidebar', Container).addClass('dopbsp-style1');
                            }
                    }
                }
...
// 11. Search
        ...
        methods_search = {
             ...
             */    
                ...
                HTML.push('<div class="inputs-header hide">');
                HTML.push(' <h3>'+methods_search.text['title']+'</h3>');
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-search'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-search'+ID+'" class="button"></a>');
                HTML.push('</div>');
                HTML.push('<div id="DOPBSP-inputs-DOPBSPReservationsAdd-search'+ID+'" class="inputs-wrapper">');
            ...
            hours: {
                 ...
                 */
                     ...
                     */
                    if (toSet === 'all'){
                        startHTML.push('<select name="DOPBSPReservationsAdd-start-hour'+ID+'" id="DOPBSPReservationsAdd-start-hour'+ID+'" class="small">');
                     ...
                     */
                    if (methods_hours.data['multipleSelect']){
                        endHTML.push('<select name="DOPBSPReservationsAdd-end-hour'+ID+'" id="DOPBSPReservationsAdd-end-hour'+ID+'" class="small">');
            ...
            no_items: {
                 ...
                 */
                    ...
                    // if (methods_sidebar.data['noItems']){
                        HTML.push(' <div id="DOPBSPReservationsAdd-no-items-wrapper'+ID+'" class="input-wrapper last">');
                 ...
                 */
                    ...
                    HTML.push('<select name="DOPBSPReservationsAdd-no-items'+ID+'" id="DOPBSPReservationsAdd-no-items'+ID+'" class="small">');
...
// 13. Extras
        ...
        methods_extras = {
             ...
             */
                ...
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-extras'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-extras'+ID+'" class="button"></a>');
                HTML.push('</div>');
                HTML.push('<div id="DOPBSP-inputs-DOPBSPReservationsAdd-extras'+ID+'" class="inputs-wrapper">');

                /*
                 * List
                 */
                for (i=0; i<extra.length; i++){
                    HTML.push('<div class="input-wrapper'+(i === extra.length-1 ? ' last':'')+'">');
             ...
             */         
                ...
                $('#DOPBSP-inputs-DOPBSPReservationsAdd-extras'+ID+' .dopbsp-message').html(message)
                                                                                      ...
                                                                                      .css('display', display);
                if (display === 'block'){
                    $('#DOPBSP-inputs-DOPBSPReservationsAdd-extras'+ID+' .input-wrapper:nth-last-child(2)').removeClass('last');
                }
                else{
                    $('#DOPBSP-inputs-DOPBSPReservationsAdd-extras'+ID+' .input-wrapper:nth-last-child(2)').addClass('last');
                }
            }
        },
...
// 16. Coupons
        ...
        methods_coupons = {
             ...
             */
                ...
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-coupons'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-coupons'+ID+'" class="button"></a>');
                HTML.push('</div>');
                HTML.push('<div id="DOPBSP-inputs-DOPBSPReservationsAdd-coupons'+ID+'" class="inputs-wrapper">');
                
                /*
                 * Code
                 */     
                HTML.push(' <div class="input-wrapper last">');
                 ...
                 * Buttons
                 */
                HTML.push(' <div id="DOPBSPReservationsAdd-coupons-buttons'+ID+'" class="input-wrapper last DOPBSPReservationsAdd-hidden">');
             ...
             */
                ...
                $('#DOPBSPReservationsAdd-coupons-code'+ID).bind('input propertychange blur', function(){
                    if ($(this).val() === ''){
                        ...
                        $('#DOPBSP-inputs-DOPBSPReservationsAdd-coupons'+ID+' .input-wrapper:first-child').removeClass('last');
...
// 18. Reservation
        ...
        methods_reservation = {
             ...
             */
                ...
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-reservation'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-reservation'+ID+'" class="button"></a>');
                HTML.push('</div>');
                HTML.push('<div id="DOPBSP-inputs-DOPBSPReservationsAdd-reservation'+ID+'" class="inputs-wrapper">');
...
// 20. Form
        ...
        methods_form = {
             ...
             */
                ...
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-form'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-form'+ID+'" class="button"></a>');
                HTML.push('</div>');
                HTML.push('<div id="DOPBSP-inputs-DOPBSPReservationsAdd-form'+ID+'" class="inputs-wrapper">');
                ...
                for (i=0; i<form.length; i++){
                    ...
                    HTML.push(' <div class="input-wrapper'+(i === form.length-1 ? ' last':'')+'">');
                    ...
                    switch (formField['type']){
                        case 'checkbox':
                             ...
                             * Checkbox field.
                             */
                            HTML.push('     <label class="for-checkbox-with-width" for="DOPBSPReservationsAdd-form-field'+ID+'_'+formField['id']+'">'+formField['translation']+(formField['required'] === 'true' ? '  <span class="dopbsp-required">*</span>':'')+'</label>');
                            ...
                            HTML.push('     <a href="javascript:void(0)" id="DOPBSPReservationsAdd-form-field-warning'+ID+'_'+formField['id']+'" class="button warning-info checkbox-warning-info"><span class="info warning-info">'+formField['translation']+' '+methods_form.text['required']+'</span></a>');
                            break;
                        case 'select':
                            /*
                             * Select field.
                            ...
                            HTML.push('     </select>');
                            HTML.push('     <a href="javascript:void(0)" id="DOPBSPReservationsAdd-form-field-warning'+ID+'_'+formField['id']+'" class="button warning-info"><span class="info warning-info">'+formField['translation']+' '+methods_form.text['required']+'</span></a>');
                            break;
                        case 'text':
                            /*
                             * Text field.
...
// 21. Order
        ...
        methods_order = {
             ...
             */
                ...
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-order'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-order'+ID+'" class="button"></a>');
                HTML.push('</div>');
                HTML.push('<div id="DOPBSP-inputs-DOPBSPReservationsAdd-order'+ID+'" class="inputs-wrapper last">');
                HTML.push(' <div class="input-wrapper">');
                HTML.push('     <label for="DOPBSPReservationsAdd-status'+ID+'">'+methods_order.text['status']+'</label>');
                HTML.push('     <select name="DOPBSPReservationsAdd-status'+ID+'" id="DOPBSPReservationsAdd-status'+ID+'">');
                HTML.push('         <option value="approved">'+methods_order.text['statusApproved']+'</option>');
                HTML.push('         <option value="pending">'+methods_order.text['statusPending']+'</option>');
                HTML.push('     </select>');
                HTML.push(' </div>');
                 ...
                 */
                HTML.push(' <div class="input-wrapper">');
                HTML.push('     <label class="for-radios">'+methods_order.text['paymentMethod']+'</label>');
                HTML.push('     <div class="checkboxes-wrapper">');

                /*
                 * No payment.
                 */
                HTML.push('         <input type="radio" name="DOPBSPReservationsAdd-payment'+ID+'" value="none" disabled="disabled" />');
                HTML.push('         <label class="for-radio">'+methods_order.text['paymentMethodNone']+'</label>');
                ...
                HTML.push('         <label class="for-radio">'+methods_order.text['paymentMethodArrival']+'</label>');
                HTML.push('         <br class="DOPBSPReservationsAdd-clear" />');
                ...
                for (key in paymentGateways){
                    ...
                    HTML.push('     <label class="for-radio">'+paymentGateways[key]['title']+'</label>');
                    HTML.push('     <br class="DOPBSPReservationsAdd-clear" />');
                }
                HTML.push('     </div>');
                HTML.push(' </div>');
                 ...
                 * Submit button.
                 */
                HTML.push(' <div id="DOPBSPReservationsAdd-order-buttons'+ID+'" class="input-wrapper DOPBSPReservationsAdd-hidden last">');
                HTML.push('     <label>&nbsp;</label>');
             ...
             */
                ...
                $('#DOPBSPReservationsAdd-transaction-id'+ID).parent().removeClass('last');
            },
            clear:function(){
            /*
             * Clear order.
             */    
                ...
                $('#DOPBSPReservationsAdd-transaction-id'+ID).parent().addClass('last');
            },
