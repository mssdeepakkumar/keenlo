...
<?php if ( $providers ) : ?>
	...
	<div class="wc-social-login">
		...
		<p><?php _e( 'Save time by creating an account using your favorite social network. No need to remember another username and password.', WC_Social_Login::TEXT_DOMAIN ); ?></p>
