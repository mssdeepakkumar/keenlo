...
class WooCommerce_Product_Vendors {
    ...
    public function edit_vendor_fields( $vendor ) {
        ...
        <tr class="form-field">
            ...
            <td>
                <textarea class="regular-text" name="vendor_data[desc2]" id="vendor_bank_name"  /><?php echo stripslashes(esc_attr($desc2)); ?></textarea><br/>
        ...
        <tr class="form-field">
            ...
            <td>
            	<input type="number" class="regular-text" name="vendor_data[commission]" id="vendor_commission" value="<?php echo stripslashes(esc_attr( $commission )); ?>" /> %<br/>
            	<span class="description"><?php _e( 'The percent of the total sale price that this vendor will receive - can be modified per product.', 'wc_product_vendors' ); ?></span>
            </td>
        </tr>
        ...
        <tr class="form-field">
            ...
            <td>
            	<input type="text" class="regular-text" name="vendor_data[paypal_email]" id="vendor_paypal_email" value="<?php echo stripslashes(esc_attr( $paypal_email )); ?>" /><br/>
	            <span class="description"><?php _e( 'The PayPal email address of the vendor where their profits will be delivered.', 'wc_product_vendors' ); ?></span>
	        </td>
        </tr>
        <tr class="form-field">
            ...
            <td>
                <input type="text" class="regular-text" name="vendor_data[bank_number]" id="vendor_bank_name" value="<?php echo stripslashes(esc_attr( $bank_number )); ?>" /><br/>
        ...
        <tr class="form-field">
            ...
            <td>
                <input type="text" maxlength="16" class="regular-text" name="vendor_data[account_number]" id="vendor_bank_name" value="<?php echo stripslashes(esc_attr( $account_number )); ?>" /><br/>
