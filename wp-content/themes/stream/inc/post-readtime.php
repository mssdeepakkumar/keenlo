<?php
	...
	register_activation_hook(get_template_directory_uri().'/inc/', 'post_readtime_install');
	register_deactivation_hook(get_template_directory_uri().'/inc/', 'post_readtime_uninstall');
	...
	function post_readtime_install() {
		...
		add_option('post_readtime_prefix', '', '', 'yes'); // Add the option for prefix to string
		add_option('post_readtime_suffix', ' read', '', 'yes'); // Add the option for suffix to string
	...
	function post_readtime_admin_menu_create() {
		add_options_page('Post Read Time Settings', 'Reading', 'administrator', get_template_directory_uri().'/inc/', 'post_readtime_settings');
	}
