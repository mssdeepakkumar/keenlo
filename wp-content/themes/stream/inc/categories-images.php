<?php
define('Z_IMAGE_PLACEHOLDER', get_template_directory_uri() .'/ico/placeholder.png');
// l10n
...
//	add_theme_page(__('Categories Images settings', 'zci'), __('Categories Images', 'zci'), 'manage_options', 'zci-options', 'zci_options');
