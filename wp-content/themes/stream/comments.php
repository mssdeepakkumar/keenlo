...
?>
	<div style="">
		<button class="homeCta" style="cursor:pointer; margin: 40px 0;" onclick="jQuery('#comments').toggle();">Toggle comments &nbsp; [ <?php echo get_comments_number() ?> ] <i class="icon-sort"></i></button>
	</div>
	...
	<?php if ( have_comments() ) : ?>
		<h4 class="comments-title">
			<?php
				printf( _nx( '1 Comment;', '%1$s Comments', get_comments_number(), 'comments title', 'upbootwp' ),
	...
	$args = array(
		...
		'comment_field' =>  '<p class="comment-form-comment"><label for="comment">' . _( 'Comment' ) .
		...
		sprintf(
			__( '<a href="%3$s" title="Log out of this account">Log out?</a>' ),
